...
class StoryBrain {
  ...
  void nextStory(int choiceNumber) {
    if(_storyNumber == 3 || _storyNumber == 4 || _storyNumber == 5) {
      ...
      _storyNumber = 1;
      print('now you are in story1');
    }
  }

  void restart() {
    _storyNumber = 0;
    print('now you restart your story');
  }
